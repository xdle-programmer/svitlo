...
<div class="animation">
    ...
    <div class="animation__slide animation__change-background businesses">
        <div class="businesses__block layout">
            ...
            <div class="animation__block">
                ...
                <div class="businesses__subtitle">
                    ...
                    <div class="businesses__subtitle-item businesses__subtitle-item--3">to achieve our client's business
                        goals.
    ...
    <div class="animation__slide lets-discuss">
        <div class="lets-discuss__block layout">
            <div class="lets-discuss__desc">
                <div class="lets-discuss__desc-item lets-discuss__desc-item--1">A website is primarily a marketing tool
                    and
    ...
    <div class="animation__slide animation__change-background process">
            ...
            <div class="process__items">
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">We discuss your business and the goals that you want to
                            achieve. The main point is to take a look at your business from the side, find growth points
                            and
                            determine the goal
                        </div>
                    </div>
                ...
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">Strategy is the key to success. We develop the plan to
                            achieve
                            the desired result, which we identified during the interview. Success will depend on the
                            right
                            strategy.
                        </div>
                    </div>
                ...
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">We analyze the target audience, competitors, CJM,
                            marketing,
                            sales, and implement marketing features. Each section of the site should do its own tasks to
                            perform the aim.
                        </div>
                    </div>
                </div>
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">Packaging plays an important role in business. We will work
                            out
                ...
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">The technical part of the implementation of your project.
                            We
                            will make sure that everything works as it should, and you receive all leads and payments.
                        </div>
                    </div>
                </div>
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">Once the site is ready, it's time to make it work. Our team
                            is
                            ready to promote your business through SEO, Google, YouTube, Facebook, Instagram, TikTok
                            ads,
                            and other channels.
                        </div>
                    </div>
                ...
                <div class="process__item">
                    ...
                    <div class="process__item-desc">
                        ...
                        <div class="process__item-desc-text">We are interested in providing you with the best results.
                            After
                            receiving the first data, we analyze it and move on to planning larger changes and
    ...
    <div class="animation__slide portfolio">
        ...
        <div class="portfolio__desc layout">
            <div class="portfolio__desc-item portfolio__desc-item--1">
                <div class="portfolio__desc-item-inner">Businesses come to us for a website, but get a lot<br>more,
                </div>
                <div class="portfolio__desc-item-inner portfolio__desc-item-inner--main-color">solutions<br>to their
                    business
                    problems.
                </div>
            </div>
            <div class="portfolio__desc-item portfolio__desc-item--2">
                If you need a “tool" that will sell, generate leads, or increase the brand recognition of your business,
    ...
    <div class="animation__slide our-services">
            ...
            <div class="our-services__items">
                ...
                <div class="our-services__item">
                    ...
                    <div class="our-services__item-desc">
                        ...
                        <div class="our-services__item-desc-text">
                            We will develop a digital strategy that will lead your business to the desired result.
                        </div>
                    </div>
                    <div class="our-services__item-link">Let's discuss</div>
                </div>
                ...
                <div class="our-services__item">
                    ...
                    <div class="our-services__item-desc">
                        ...
                        <div class="our-services__item-desc-text">
                            If you only need a design, we are ready to help. We can design a website, app, or platform.
                        </div>
                    </div>
                    <div class="our-services__item-link">Let's discuss</div>
                </div>
                ...
                <div class="our-services__item">
                    ...
                    <div class="our-services__item-desc">
                        ...
                        <div class="our-services__item-desc-text">
                            We will identify the right channel and promote your business through SEO, Google,<br>
    ...
    <div class="animation__slide we-are">
        <div class="we-are__block layout">
            <div class="we-are__subtitle">
                <div class="we-are__subtitle-item">
                    ...
                    <div class="we-are__subtitle-item-text">a boutique web production created by Ukrainians during the
                        war.
                    </div>
                </div>
                ...
                <div class="we-are__desc-item we-are__desc-item--2">
                    ...
                    <div class="we-are__desc-item-text we-are__desc-item-text--2">
                        <div class="we-are__desc-item-text-line">
                            Even this website we were making in shelters, during the sound of gunshots and airstrikes,
                            now
    ...
    <div class="animation__slide clients">
        ...
        <div class="clients__block layout">
            ...
            <div class="clients__item clients__item--2">
                <img class="clients__item-img clients__item-img--creo" src="./assets/images/client-creo.png">
            </div>

            <div class="clients__item clients__item--main clients__item--3">
                <img class="clients__item-img clients__item-img--0-100" src="./assets/images/client-0-100.png">
            </div>

            <div class="clients__item clients__item--4">
                <img class="clients__item-img clients__item-img--traffic" src="./assets/images/client-traffic.png">
            </div>

            <div class="clients__item clients__item--5">
                <img class="clients__item-img clients__item-img--chart" src="./assets/images/client-chart.png">
            </div>

            <div class="clients__item clients__item--6">
                <img class="clients__item-img clients__item-img--vooodoo" src="./assets/images/client-vooodoo.png">
            </div>

            <div class="clients__item clients__item--main clients__item--7">
                <img class="clients__item-img clients__item-img--other" src="./assets/images/client-other.png">
            </div>
        </div>
    </div>

    <div class="animation__slide animation__change-background have-a-task">
        <div class="have-a-task__block layout">
            ...
            <div class="have-a-task__form form-check">
                <div class="have-a-task__form-items">
                    ...
                    <div class="have-a-task__form-item">
                        <div class="placeholder placeholder--textarea form-check__field" data-elem="textarea"
