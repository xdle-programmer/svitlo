...
function animation($wrapper) {
  ...
  let lastScroll = window.scrollY; // Классы и модификаторы
  ...
  const slideFadeClass = 'animation__block--fade'; // Элементы со сдвигом фона
  ...
  const blocks = Array.from($wrapper.querySelectorAll(`.${blockClass}`)); // Функция установки высоты бади
  ...
  scroll(); // Функция проверки положения скролла и передвижения враппера
...
/******/ })()
;
//# sourceMappingURL=main.4b0b0ab45e1e57c6e4c3.js.map