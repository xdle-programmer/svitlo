...
function animation($wrapper) {
  ...
  let slideTextAreas = []; // Классы, модификаторы и селекторы
  ...
  const screens = Array.from($wrapper.querySelectorAll(`.${screenClass}`)); // Переменные опций анимации
  ...
  function calcScreenSizes() {
    ...
    for (let index = 0; index < screens.length; index++) {
      ...
      let bottom = top + screenHeight; // Установка области доскрола
      ...
      if ($screen.classList.contains(screenChangeBackgroundClass)) {
        ...
        screensChangeBackgroundAreas.push({
          top: changeBackgroundTop,
          bottom: changeBackgroundBottom,
          topScreen: top
        });
      }
  ...
  window.addEventListener('scroll222', event => {
    ...
    if (checkScroll) {
      ...
      $wrapper.style.transform = `matrix(1.00,0.00,0.00,1.00,0,-${window.scrollY - shiftScroll})`; // $wrapper.scrollTo(0, window.scrollY - shiftScroll)
    }
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio__slider .swiper', {
  ...
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, _panorama_panorama__WEBPACK_IMPORTED_MODULE_3__["default"]],
...
/******/ })()
;
//# sourceMappingURL=main.42a17e6d9375a77372d1.js.map