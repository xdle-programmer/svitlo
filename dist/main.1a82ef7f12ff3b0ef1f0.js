...
function animation($wrapper) {
  ...
  let screensSizes = [];
  let slideTextAreas = []; // Переменные для текущего состояния скролла
  ...
  let lastWheelDeltaY = false; // Переменные для настроек скролла
  ...
  const countingDuration = 1000; // Переменные для функций конструкторов
  ...
  function calcScreenSizes() {
    ...
    for (let index = 0; index < screens.length; index++) {
      ...
      let slideTextScrollHeight = 0; // Установка верхней границы экрана
      ...
      if ($screen.querySelector(`.${slideTextClass}`)) {
        ...
        slideTextAreas.push({
          top: top,
          bottom: slideTextBottom,
          scrollHeight: slideTextScrollHeight,
          $slideText
        });
      } // Установка нижней границы экрана


      let bottom = top + screenHeight; // Переменные для установки доскрола

      let changeBackground = false;
      let changeBackgroundTop = 0;
      let changeBackgroundHeight = 0; // Установка области доскрола
  ...
  function setBodyHeight() {// $body.style.height = originalHeight + 'px';
  ...
  function ChangeScreenPosition() {
    ...
    function changePosition(scrollY) {
      for (let index = 0; index < screens.length; index++) {
        ...
        const {
          changeBackgroundHeight
        } = screensSizes[index]; // Если экран находится в зоне видимости
  ...
  function SetEffects() {
    ...
    const logos = $wrapper.querySelectorAll('.clients__item--main'); // Функция добавления классов для тайтлов
...
function getLightness(r, g, b) {
  ...
  let lightness = 0; // Calculate lightness
...
/* harmony export */   "setId": function() { return /* binding */ setId; }
/* harmony export */ });
function setId($elem) {
  if ($elem.id !== '') {
    return $elem.id;
...
class Validation {
  ...
  constructor(options) {
    ...
    this.inputFocusClass = options && options.inputFocusClass ? options.inputFocusClass : 'form-check__field--focus';
    this.buttonClass = options && options.buttonClass ? options.buttonClass : 'form-check__button';
    this.$buttons = options && options.$buttons ? options.$buttons : this.$form.getElementsByClassName(this.buttonClass);
  ...
  createFieldsArray() {
    ...
    for (let $formField of this.$formFields) {
      ...
      let rules = $formField.dataset.rule.split(', '); // Определяем элемент, который будем проверять
  ...
  validateField(field, showError) {
    let errors = []; // Выполняем последовательно проверки
...
if (forms.length > 0) {
  for (let index = 0; index < forms.length; index++) {
    ...
    let id = setId($form);
    window.formsArray.set(id, new Validation({
      $form: $form
    }));
    window.formsArray.get(id).init();
  }
}

/***/ }),

/***/ "./src/have-a-task/have-a-task.js":
/*!****************************************!*\
  !*** ./src/have-a-task/have-a-task.js ***!
  \****************************************/
/***/ (function() {
...
/***/ "./src/lets-discuss/lets-discuss.js":
/*!******************************************!*\
  !*** ./src/lets-discuss/lets-discuss.js ***!
  \******************************************/
/***/ (function() {
...
function loadIntro() {
  ...
  setLoadProgress(); // Функция рекурсии алгоритмического скролла
  ...
  function setLoadProgress() {
    axios.get('/assets/video/intro-video.mp4', {
      ...
      const videoBlob = (window.URL || window.webkitURL).createObjectURL(new Blob([response.data], {
        type: "video/mp4"
      }));
...
function startVideo() {
  (0,_animation_animation__WEBPACK_IMPORTED_MODULE_0__.animationStart)($animation);
}

/***/ }),

/***/ "./src/magnet/magnet.js":
/*!******************************!*\
  !*** ./src/magnet/magnet.js ***!
  \******************************/
/***/ (function() {
...
function magnet($wrapper) {
  ...
  function draw() {
    ...
    let cp1_2 = [x + r + subShiftX, y - initRShift + subShiftY]; // Вторая кривая (по часовой стрелке 3 - 6)

    let p2 = [x + r + subShiftX, y + subShiftY];
    let cp2_1 = [x + r + subShiftX, y + initRShift + subShiftY];
    let cp2_2 = [x + initRShift + subShiftX, y + r + subShiftY]; // Третья кривая (по часовой стрелке 6 - 9)

    let p3 = [x + subShiftX, y + r + subShiftY];
    let cp3_1 = [x - initRShift + subShiftX, y + r + subShiftY];
    let cp3_2 = [x - r - currentShiftX, y + initRShift + currentShiftY]; // Четвертая кривая (по часовой стрелке 9 - 12)
...
/***/ "./src/our-services/our-services.js":
/*!******************************************!*\
  !*** ./src/our-services/our-services.js ***!
  \******************************************/
/***/ (function() {
...
function slider($wrapper) {
  ...
  if (window.innerWidth > _index__WEBPACK_IMPORTED_MODULE_3__.mobileViewPoint) {
    swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio__slider .swiper--desktop', {
    ...
    swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio__slider .swiper--mobile', {
...
/***/ "./src/user-experience/user-experience.js":
/*!************************************************!*\
  !*** ./src/user-experience/user-experience.js ***!
  \************************************************/
/***/ (function() {
...
/***/ "./src/case-intro/case-intro.scss":
/*!****************************************!*\
  !*** ./src/case-intro/case-intro.scss ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/flashlight/flashlight.scss":
/*!****************************************!*\
  !*** ./src/flashlight/flashlight.scss ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/form-check/form-check.scss":
/*!****************************************!*\
  !*** ./src/form-check/form-check.scss ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/have-a-task/have-a-task.scss":
/*!******************************************!*\
  !*** ./src/have-a-task/have-a-task.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/lets-discuss/lets-discuss.scss":
/*!********************************************!*\
  !*** ./src/lets-discuss/lets-discuss.scss ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/logo-circle/logo-circle.scss":
/*!******************************************!*\
  !*** ./src/logo-circle/logo-circle.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/our-services/our-services.scss":
/*!********************************************!*\
  !*** ./src/our-services/our-services.scss ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/placeholder/placeholder.scss":
/*!******************************************!*\
  !*** ./src/placeholder/placeholder.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/testimonial/testimonial.scss":
/*!******************************************!*\
  !*** ./src/testimonial/testimonial.scss ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/user-experience/user-experience.scss":
/*!**************************************************!*\
  !*** ./src/user-experience/user-experience.scss ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	__webpack_require__("./src/flashlight/flashlight.js");
/******/ 	__webpack_require__("./src/footer/footer.js");
/******/ 	__webpack_require__("./src/form-check/form-check.js");
/******/ 	__webpack_require__("./src/have-a-task/have-a-task.js");
/******/ 	__webpack_require__("./src/header/header.js");
/******/ 	__webpack_require__("./src/intro/intro.js");
/******/ 	__webpack_require__("./src/lets-discuss/lets-discuss.js");
/******/ 	__webpack_require__("./src/light/light.js");
...
/******/ 	__webpack_require__("./src/not-found/not-found.js");
/******/ 	__webpack_require__("./src/our-services/our-services.js");
/******/ 	__webpack_require__("./src/placeholder/placeholder.js");
/******/ 	__webpack_require__("./src/portfolio/portfolio.js");
/******/ 	__webpack_require__("./src/process/process.js");
/******/ 	__webpack_require__("./src/social/social.js");
/******/ 	__webpack_require__("./src/testimonial/testimonial.js");
/******/ 	__webpack_require__("./src/thank-you/thank-you.js");
/******/ 	__webpack_require__("./src/user-experience/user-experience.js");
/******/ 	__webpack_require__("./src/we-are/we-are.js");
/******/ 	__webpack_require__("./src/animation/animation.scss");
/******/ 	__webpack_require__("./src/base/main.scss");
/******/ 	__webpack_require__("./src/base/media-queries.scss");
...
/******/ 	__webpack_require__("./src/case-intro/case-intro.scss");
/******/ 	__webpack_require__("./src/char-hover/char-hover.scss");
/******/ 	__webpack_require__("./src/clients/clients.scss");
/******/ 	__webpack_require__("./src/flashlight/flashlight.scss");
/******/ 	__webpack_require__("./src/footer/footer.scss");
/******/ 	__webpack_require__("./src/form-check/form-check.scss");
/******/ 	__webpack_require__("./src/have-a-task/have-a-task.scss");
/******/ 	__webpack_require__("./src/header/header.scss");
/******/ 	__webpack_require__("./src/input/input.scss");
/******/ 	__webpack_require__("./src/intro/intro.scss");
/******/ 	__webpack_require__("./src/layout/layout.scss");
/******/ 	__webpack_require__("./src/lets-discuss/lets-discuss.scss");
/******/ 	__webpack_require__("./src/light/light.scss");
/******/ 	__webpack_require__("./src/loader/loader.scss");
/******/ 	__webpack_require__("./src/logo-circle/logo-circle.scss");
/******/ 	__webpack_require__("./src/magnet/magnet.scss");
/******/ 	__webpack_require__("./src/menu/menu.scss");
/******/ 	__webpack_require__("./src/modal/modal.scss");
/******/ 	__webpack_require__("./src/not-found/not-found.scss");
/******/ 	__webpack_require__("./src/our-services/our-services.scss");
/******/ 	__webpack_require__("./src/placeholder/placeholder.scss");
/******/ 	__webpack_require__("./src/portfolio/portfolio.scss");
/******/ 	__webpack_require__("./src/process/process.scss");
/******/ 	__webpack_require__("./src/social/social.scss");
/******/ 	__webpack_require__("./src/testimonial/testimonial.scss");
/******/ 	__webpack_require__("./src/thank-you/thank-you.scss");
/******/ 	__webpack_require__("./src/user-experience/user-experience.scss");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/we-are/we-are.scss");
/******/ 	
/******/ })()
;
//# sourceMappingURL=main.1a82ef7f12ff3b0ef1f0.js.map